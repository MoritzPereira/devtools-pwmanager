...
public class PwManagerHomeScreenController extends Controller implements Initializable {
  ...
  public void openDialogAddEntry() {
    ...
    btOk.addEventFilter(
        ...
        event -> {
          try {
            pwManagerService.addEntry(urlText.getText(), usernameText.getText(),
                emailText.getText(), passwordText.getText(), rpasswordText.getText());
          } catch (IllegalParameterException e) {
  ...
  public void openDialogEditEntry(Entry entry) {
    ...
    saveButton.addEventFilter(
        ...
        event -> {
          ...
          if (checkMasterPw) {
            try {
              pwManagerService.changeEntry(
                  new Entry(entry.getEntryId(), urlText.getText(), usernameText.getText(),
                      emailText.getText(), passwordText.getText()), password);
  ...
  public void openDialogChangeMasterPW() {
    ...
    btOk.addEventFilter(
        ...
        event -> {
          try {
            pwManagerService.changeMasterPw(newmasterpasswordText.getText(),
                rnewmasterpasswordText.getText(), oldmasterpasswordText.getText());
          ...
          if (useuppercaseBox.isSelected() || uselowercaseBox.isSelected() ||
            ...
            try {
              pwManagerService.generateNewPw(useuppercaseBox.isSelected(),
                  ...
                  usespecialsBox.isSelected(), usecyrillicBox.isSelected(),
                  Integer.parseInt(numbersText.getText()));
