...
public class PwManagerUsageDemo {
    ...
    public static void main(String[] args) throws IllegalMasterPasswordException, IllegalParameterException {
        ...
        //Adds an Entry
        Entry entry = pwManagerService.addEntry("c-shark.de", "Swifty", "shasse@stud.hs-heilbronn.de", "Floistcool", "Floistcool");
        ...
        String newpw = pwManagerService.generateNewPw(true, true, true, true, true,8);
